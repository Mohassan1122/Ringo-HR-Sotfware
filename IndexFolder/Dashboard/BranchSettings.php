...
if (strlen($_SESSION['company_email']) == 0) {
    ...
    if (isset($_GET['inid'])) {
        ...
        header('location:./BranchSettings.php');
    }
                                    ...
                                    <div class="page-header">
                                        <div class="row align-items-center ">
                                            ...
                                            <div class="col-auto float-right ml-auto">
                                                <a href="addBranch.php" class="btn btn-primary add-btn"><i class="fa fa-plus"></i> Add Location</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card mt-5">
                                        ...
                                        <table class="table table-striped mt-5">
                                            ...
                                            <tbody>
                                                <?php
                                                $faculty = $conn->query("SELECT * FROM branch");
                                                while ($result = $faculty->fetch_array()) :
                                                ?>
                                                    <tr>
                                                        <th><?php echo ucwords($result['city']) ?> </th>
                                                        <td><?php echo htmlentities($result['address']); ?></td>

                                                        <td><a href="./editBranch.php?empid=<?php echo htmlentities($result['id']); ?>"><i class="fas fa-edit"></i></a>

                                                            <a href="./BranchSettings.php?inid=<?php echo htmlentities($result['id']); ?>" onclick="return confirm('Are you sure you want to inactive this Employe?');"" > <i class=" fas fa-trash-alt"></i>
