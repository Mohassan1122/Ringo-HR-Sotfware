...
if (strlen($_SESSION['company_email']) == 0) {
    ...
    if (isset($_GET['inid'])) {
        ...
        header('location:./deptSettings.php');
    }
                                    ...
                                    <div class="page-header">
                                        <div class="row align-items-center ">
                                            ...
                                            <div class="col-auto float-right ml-auto">
                                                <a href="addDept.php" class="btn btn-primary add-btn"><i class="fa fa-plus"></i> Add Department</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card mt-5">
                                        ...
                                        <table class="table table-striped mt-5">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">Depy Short Name</th>
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $faculty = $conn->query("SELECT * FROM department ");
                                                while ($result = $faculty->fetch_array()) :
                                                ?>
                                                    <tr>
                                                        <th><?php echo ucwords($result['deptname']) ?> </th>
                                                        <td><?php echo htmlentities($result['deptsht']); ?></td>
                                                        <td><?php echo htmlentities($result['created_at']); ?></td>

                                                        <td><a href="./editDept.php?empid=<?php echo htmlentities($result['id']); ?>"><i class="fas fa-edit"></i></a>

                                                            <a href="./deptSettings.php?inid=<?php echo htmlentities($result['id']); ?>" onclick="return confirm('Are you sure you want remove department?');"" > <i class=" fas fa-trash-alt"></i>
