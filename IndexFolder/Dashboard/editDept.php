...
if (strlen($_SESSION['company_email']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $result = mysqli_query($conn, "UPDATE department set deptname='" . $deptname . "', deptsht='" . $deptsht . "' WHERE id='" . $eid . "'");

        if ($result) {
            echo "<script>alert('Depatment updated successfully');</script>";
            echo "<script>window.location.href='./deptSettings.php';</script>";
        } else {
                    ...
                    <div class="container mt-5">
                        <div class="row d-flex justify-content-center align-items-center">
                            <div class="col-md-8">
                                ...
                                <?php
                                $eid = intval($_GET['empid']);
                                $query = $conn->query("SELECT * FROM department where id=$eid");
                                while ($result = $query->fetch_array()) :
                                ?>
                                    <h1 class="text-center">Add Department</h1>
                                    <div class="tab">
                                        <h6>Department Name</h6>
                                        <p> <input value="<?php echo htmlentities($result['deptname']); ?>" type="text" name="deptname"></p>
                                    </div>
                                    <div class="tab">
                                        <h6>Department Short Name</h6>
                                        <p><input value="<?php echo htmlentities($result['deptsht']); ?>" type="text" name="deptsht"></p>
                                    </div>
                                    <?php endwhile; ?>
                                    <div class="tab">
