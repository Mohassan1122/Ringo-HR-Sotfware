...
if (strlen($_SESSION['company_email']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $result = mysqli_query($conn, "UPDATE employee set fname='" . $fname . "', email='" . $email . "', birthday='" . $birthday . "' , addr='" . $addr . "',  mobile='" . $mobile . "' ,  dept='" . $dept . "' ,  role='" . $role . "' ,  pic='" . $pic . "' WHERE id='" . $eid . "'");

        if ($result) {
            echo "<script>alert('Employee detail updated successfully');</script>";
                    ...
                    <div class="container">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="">
                                <?php
                                $eid = intval($_GET['empid']);
                                $query = $conn->query("SELECT * FROM employee where id=$eid");
                                ...
                                ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="fname" value="<?php echo htmlentities($result['fname']); ?>" class="form-control">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="birthday" value="<?php echo htmlentities($result['birthday']); ?>" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="addr" value="<?php echo htmlentities($result['addr']); ?>" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Mobile</label>
                                                <input type="text" name="mobile" value="<?php echo htmlentities($result['mobile']); ?>" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="dept" name="dept" class="form-control">
                                                    ...
                                                    ?>
                                                        <option><?php echo ucwords($row['dept']) ?></option>
                                                    <?php endwhile; ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="file" name="pic" value="<?php echo htmlentities($result['pic']); ?>" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                <?php endwhile; ?>
                                <button type="submit" name="update" class="btn mt-3 btn-primary">Update Employee</button>
