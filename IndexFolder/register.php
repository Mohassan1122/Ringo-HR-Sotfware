                    ...
                    <div class="col-lg-5">
                        <div class="card bg-secondary shadow border-0">
                            ...
                            <div class="card-body px-lg-5 py-lg-5">
                                ...
                                <form method="post" action="../includeFolder/regFuction.php" accept-charset='UTF-8'>
                                    <?php include('../includeFolder/error.php'); ?>
                                    <?php include('../includeFolder/success.php'); ?>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group input-group-alternative mb-3">
                                            ...
                                            <input class="form-control" placeholder="Company Logo" type="file" name="company_logo">
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-center">
                                        <button type="submit" name="button" class="btn btn-primary mt-2">Create account</button>
                                    </div>
                                </form>
